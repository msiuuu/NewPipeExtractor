...
public class PornHubPlaylistInfoItemExtractor implements PlaylistInfoItemExtractor {
    private final Element searchResult;
    private final Element resultInfo;

    public PornHubPlaylistInfoItemExtractor(@Nonnull final Element searchResult) {
