...
public class PornHubPlaylistInfoItemFeaturedExtractor implements PlaylistInfoItemExtractor {

    private final JsonObject featuredStory;

    public PornHubPlaylistInfoItemFeaturedExtractor(final JsonObject featuredStory) {
