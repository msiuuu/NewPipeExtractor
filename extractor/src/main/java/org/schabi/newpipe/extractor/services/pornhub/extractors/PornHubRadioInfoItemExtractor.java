...
public class PornHubRadioInfoItemExtractor implements StreamInfoItemExtractor {

    private final JsonObject show;

    public PornHubRadioInfoItemExtractor(final JsonObject radioShow) {
        show = radioShow;
    }
    ...
    public String getUploaderName() {
        // The "title" field contains the title of the series, e.g. "PornHub Weekly".
