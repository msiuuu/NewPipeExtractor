...
import static org.schabi.newpipe.extractor.services.pornhub.extractors.PornHubExtractorHelper.BASE_API_URL;
import static org.schabi.newpipe.extractor.services.pornhub.extractors.PornHubExtractorHelper.BASE_URL;
import static org.schabi.newpipe.extractor.services.pornhub.extractors.PornHubExtractorHelper.getImageUrl;
...
public class PornHubRadioStreamExtractor extends PornHubStreamExtractor {

    private static final String OPUS_LO = "opus-lo";
    private static final String MP3_128 = "mp3-128";
    private JsonObject showInfo;

    public PornHubRadioStreamExtractor(final StreamingService service,
    ...
    public String getName() throws ParsingException {
         ...
         * items to show the same title, e.g. "PornHub Weekly".
         */
    ...
    public List<Image> getUploaderAvatars() {
        return Collections.singletonList(
                new Image(BASE_URL + "/img/buttons/pornhub-button-circle-whitecolor-512.png",
    ...
    public String getLicence() {
        // Contrary to other PornHub streams, radio streams don't have a license
        return "";
    }
    ...
    public String getCategory() {
        // Contrary to other PornHub streams, radio streams don't have categories
        return "";
    }
    ...
    public List<String> getTags() {
        // Contrary to other PornHub streams, radio streams don't have tags
        return Collections.emptyList();
    }

    @Override
    public PlaylistInfoItemsCollector getRelatedItems() {
        // Contrary to other PornHub streams, radio streams don't have related items
        return null;
    }
}
