 ...
 */
public class PornHubRelatedPlaylistInfoItemExtractor implements PlaylistInfoItemExtractor {
    private final Element relatedAlbum;

    public PornHubRelatedPlaylistInfoItemExtractor(@Nonnull final Element relatedAlbum) {
