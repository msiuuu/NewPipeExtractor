...
public class PornHubSearchExtractor extends SearchExtractor {
    ...
    public InfoItemsPage<InfoItem> getPage(final Page page)
        ...
        for (final Element searchResult : d.getElementsByClass("searchresult")) {
            ...
            switch (type) {
                case "ARTIST":
                    collector.commit(new PornHubChannelInfoItemExtractor(searchResult));
                    break;
                case "ALBUM":
                    collector.commit(new PornHubPlaylistInfoItemExtractor(searchResult));
                    break;
                case "TRACK":
                    collector.commit(new PornHubSearchStreamInfoItemExtractor(searchResult, null));
                    break;
                default:
