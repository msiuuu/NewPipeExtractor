...
public class PornHubPlaylistStreamInfoItemExtractor extends PornHubStreamInfoItemExtractor {

    private final JsonObject track;
    private List<Image> substituteCovers;
    private final StreamingService service;

    public PornHubPlaylistStreamInfoItemExtractor(final JsonObject track,
