...
import static org.schabi.newpipe.extractor.services.pornhub.extractors.PornHubExtractorHelper.getImagesFromSearchResult;

public class PornHubSearchStreamInfoItemExtractor extends PornHubStreamInfoItemExtractor {

    private final Element resultInfo;
    private final Element searchResult;

    public PornHubSearchStreamInfoItemExtractor(final Element searchResult,
